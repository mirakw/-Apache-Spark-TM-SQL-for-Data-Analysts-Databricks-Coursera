...
DROP TABLE IF EXISTS health_tracker_data;              

CREATE TABLE health_tracker_data                       
USING json                                             
OPTIONS (
...
DROP TABLE IF EXISTS health_tracker_data_late;              

CREATE TABLE health_tracker_data_late                        
USING json                                             
OPTIONS (
  path "dbfs:/mnt/training/healthcare/tracker/raw-late.json",
  inferSchema "true"
  );
select count(*) from health_tracker_data_late
...
Select count(*) From health_tracker_gold
